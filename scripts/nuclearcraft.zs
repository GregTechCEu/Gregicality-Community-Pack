...
val solders = [<liquid:soldering_alloy>, <liquid:lead>*2, <liquid:tin>*2] as ILiquidStack[];
...
for solder in solders{
	...
	assembler.recipeBuilder()
	.inputs([hulls[4], <ore:ingotZircaloy>*2, <ore:plateAdvanced>*4, <ore:ingotTough>*2, <ore:frameGtZirconiumCarbide>*4])
	...
	assembler.recipeBuilder()
	.inputs([hulls[4] , <ore:ingotTough>*4, <ore:plateHslasteel>*4 , <ore:circuitElite>*1])
	...
	assembler.recipeBuilder()
	.inputs([hulls[4], <ore:plateElite>*4, <ore:ingotExtreme>*1])
...
forming_press.recipeBuilder()
.inputs([<ore:plateBasic>*1, <ore:ingotTough>*2, <ore:plateRedstone>*2])
